...
from fileutils import get_images_from_dir
	...
	for detector in detectors:
		for descriptor in descriptors:
			...
			bench = Benchmark(detector, descriptor)
   			files = get_images_from_dir('bark')
      			files += get_images_from_dir('bikes')
   			files += get_images_from_dir('boat')
			files += get_images_from_dir('graf')
			files += get_images_from_dir('leuven')
			files += get_images_from_dir('trees')
			files += get_images_from_dir('ubc')
			files += get_images_from_dir('wall')
